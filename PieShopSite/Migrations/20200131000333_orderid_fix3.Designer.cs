...
namespace PieShopSite.Migrations
{
    ...
    [Migration("20200131000333_orderid_fix3")]
    partial class orderid_fix3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PieShopSite.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("PieShopSite.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("PieShopSite.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("PieShopSite.Models.OrderDetail", b =>
                {
                    b.HasOne("PieShopSite.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PieShopSite.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
